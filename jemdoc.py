...
def insertmenuitems(f, mname, current, prefix):
    ...
    while pc(controlstruct(m)) != '':
        ...
        else:  # menu category and menu box
            if boxcount > 0:
                out(f.outf, f.conf['menuboxend'])
            out(f.outf, f.conf['menuboxstart'])
    ...
    for (r, wl) in rs:
        ...
        while m:
            ...
            if wl:
                ...
                b = b[
                    :m.start()] + 'BACKSLASH65358OPENBRACKET65358' + eqtext + 'BACKSLASH65358CLOSEBRACKET65358' + b[
                                                                                                                  m.end():]
...
def procfile(f):
    ...
    if menu:
        out(f.outf, f.conf['wrapperstart'])
