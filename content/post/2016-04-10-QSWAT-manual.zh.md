+++
title= "利用QSWAT进行SWAT建模(QSWAT教程)"
date = "2016-04-11"
tags = ["QSWAT"]
summary = """由于ArcGIS的广泛使用，[ArcSWAT](http://swat.tamu.edu/software/arcswat/ "ArcSWAT")顺理成章成为SWAT建模者的首选，但相信很多人和我一样，使用ArcSWAT（尤其指适配ArcGIS 10.x版本的）时，经常遇到莫名其妙的COM组件错误，无从查错，只能一遍遍重来……重来……重来…… 为何不试试开源的[QSWAT](http://swat.tamu.edu/software/qswat/ "QSWAT")呢？
"""
[header]
image = ""
caption = ""
